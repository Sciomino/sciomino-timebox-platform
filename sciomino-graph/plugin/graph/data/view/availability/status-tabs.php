	...
	<div id="content-bottom">
		...
		<div class="tabs">
		   ...
		   <div class="tab">
			   ...
			   <label for="tab-1"><nobr><?php echo language('graph_availability_text_tab1'); ?></nobr></label>
		   ...
		   <div class="tab">
			   ...
			   <label for="tab-2"><nobr><?php echo language('graph_availability_text_tab2'); ?></nobr></label>
