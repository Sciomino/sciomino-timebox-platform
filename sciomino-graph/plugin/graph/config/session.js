...
Session.View = {
  ...
  //
  load: function() {
	SessionTransfer.request("GET", "/session/view", "", "Session.View.load_callback", "TEXT");
  },
...
Session.Activate = {
  ...
  //
  load: function(key) {
	SessionTransfer.request("GET", "/session/activate?key="+key, "", "Session.Activate.load_callback", "TEXT");
  },
...
Session.Logout = {
  ...
  //
  load: function() {
	SessionTransfer.request("GET", "/session/logout", "", "Session.Logout.load_callback", "TEXT");
  },
...
Session.Register = {
  ...
  //
  load: function() {
	SessionTransfer.request("GET", "/session/new", "", "Session.Register.load_callback", "TEXT");
  },
  ...
  newAction: function() {
	...
	e_value = document.getElementById("register_form").mail.value;
        ...
        if (stat == 1 ) {
                ...
                SessionTransfer.request("GET", "/session/new?"+vars, "","Session.Register.newAction_callback", "TEXT");
        }
...
Session.Login = {
  ...
  //
  load: function() {
	SessionTransfer.request("GET", "/session/login", "", "Session.Login.load_callback", "TEXT");
  },
  ...
  newAction: function() {
	...
	if (SessionRedirectLoginUrl) {
        ...
        if (stat == 1 ) {
                ...
                SessionTransfer.request("POST", "/session/login", vars,"Session.Login.newAction_callback", "TEXT");
        }
...
Session.Password = {
  ...
  //
  load: function() {
	SessionTransfer.request("GET", "/session/passNew", "", "Session.Password.load_callback", "TEXT");
  },
  ...
  newAction: function() {
	...
	e_value = document.getElementById("pass_form").mail.value;
        ...
        if (stat == 1 ) {
                vars = e_name + '=' + e_value;
                SessionTransfer.request("GET", "/session/passNew?"+vars, "","Session.Password.newAction_callback", "TEXT");
        }
  ...
  updateAction: function() {
	...
	p3_value = document.getElementById("pass_form").passNew2.value;
        ...
        if (stat == 1 ) {
                ...
                SessionTransfer.request("GET", "/session/passUpdate?"+vars, "","Session.Password.updateAction_callback", "TEXT");
        }
