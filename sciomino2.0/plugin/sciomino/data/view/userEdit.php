...
<body>
	...
	<div id="Content">
		...
		<div class="page">
			<div class="unit unit2-3">
				...
				<div class="section form" id="Form-personal-details">
					<div class="hgroup">
						<h2><?php echo language('sciomio_header_user_personalia'); ?></h2>
						<h3><?php echo language('sciomio_text_user_personalia'); ?></h3>
					</div>
	...
	<script type="text/javascript">
		...
		addLoadEvent(function() {ScioMino.User.loadProfile();});
	</script>
