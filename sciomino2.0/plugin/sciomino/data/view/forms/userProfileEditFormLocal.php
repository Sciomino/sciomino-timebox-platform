...
<input class='form_input' type='hidden' name='photo' value="<?php echo $session['response']['param']['user']['photo']; ?>">
	<fieldset class="img-item highlight">
		...
		<div class="bd">
			...
			<div class="inputset">
			    ...
			    <input class="text" type="text" name="title" id="title" value="<?php echo htmlTokens($session['response']['param']['user']['title']); ?>" maxlength="128" />
			</div>
			<div class="inputset">
			    <label for="firstName"><?php echo language('sciomio_text_user_profile_firstname'); ?></label>
			    <input class="text" type="text" name="firstName" id="firstName" value="<?php echo htmlTokens($session['response']['param']['user']['FirstName']); ?>" maxlength="128" />
			</div>
			<div class="inputset">
			    <label for="lastName"><?php echo language('sciomio_text_user_profile_lastname'); ?></label>
			    <input class="text" type="text" name="lastName" id="lastName" value="<?php echo htmlTokens($session['response']['param']['user']['LastName']); ?>" maxlength="128" />
			</div>
	...
	<fieldset>
		...
		if (! in_array("industry", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text autocomplete' data-results='".$XCOW_B['url']."/snippet/suggest-local?type=industry' type='text' name='industry' id='industry' value='".htmlTokens($session['response']['param']['organization']['Current']['industry'])."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("company", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text autocomplete' data-results='".$XCOW_B['url']."/snippet/suggest-local?type=organization' type='text' name='company' id='company' value='".htmlTokens($session['response']['param']['organization']['Current']['company'])."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("building", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='building' id='building' value='".htmlTokens($session['response']['param']['organization']['Current']['building'])."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("room", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='room' id='room' value='".htmlTokens($session['response']['param']['organization']['Current']['room'])."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("role", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text autocomplete' data-results='".$XCOW_B['url']."/snippet/suggest-local?type=role' type='text' name='role' id='role' value='".htmlTokens($session['response']['param']['organization']['Current']['role'])."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("division", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text autocomplete' data-results='".$XCOW_B['url']."/snippet/suggest-local?type=businessunit' type='text' name='division' id='division' value='".htmlTokens($session['response']['param']['organization']['Current']['division'])."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("section", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text autocomplete' data-results='".$XCOW_B['url']."/snippet/suggest-local?type=section' type='text' name='section' id='section' value='".htmlTokens($session['response']['param']['organization']['Current']['section'])."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("parttime", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='parttime' id='parttime' value='".htmlTokens($session['response']['param']['organization']['Current']['parttime'])."' maxlength='128' />";
			echo "</div>";
		}
		?>
		<!--
		<div class="inputset">
			...
			<input class="text" type="text" name="startDate" id="freestartDatevalue="<?php echo $session['response']['param']['organization']['Current']['startDate']; ?>" />
		</div>
		<div class="inputset">
			<label for="endDate"><?php echo language('sciomio_text_user_profile_work_enddate'); ?></label>
			<input class="text" type="text" name="endDate" id="endDate" value="<?php echo $session['response']['param']['organization']['Current']['endDate']; ?>" />
		</div>
		-->
	</fieldset>
	...
	<fieldset>
		...
		<?php
		// only email may be excluded, because this can be the loginname
		if (! in_array("email", $XCOW_B['sciomino']['personalia-exclude']) ) {
			if (in_array("email", $XCOW_B['sciomino']['personalia-filled'])) {$prefill = "prefill"; $readonly = "readonly";} else { $prefill = ""; $readonly = "";} 
			echo "<div class='inputset'>";
			echo "<label for='emailWork'>".language('sciomio_text_user_profile_contact_work_email')."</label>";
			echo "<input ".$readonly." class='text ".$prefill."' type='email' name='emailWork' id='emailWork' value='".$session['response']['param']['contact']['Work']['email']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("telIntern", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='telInternWork' id='telInternWork' value='".$session['response']['param']['contact']['Work']['telIntern']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("telExtern", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='telExternWork' id='telExternWork' value='".$session['response']['param']['contact']['Work']['telExtern']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("mobile", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='telMobileWork' id='telMobileWork' value='".$session['response']['param']['contact']['Work']['telMobile']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("lync", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='telLyncWork' id='telLyncWork' value='".$session['response']['param']['contact']['Work']['telLync']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("pager", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='telPagerWork' id='telPagerWork' value='".$session['response']['param']['contact']['Work']['telPager']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("fax", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='telFaxWork' id='telFaxWork' value='".$session['response']['param']['contact']['Work']['telFax']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("pac", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='pac' id='pac' value='".$session['response']['param']['contact']['Work']['pac']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("myId", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='myId' id='myId' value='".$session['response']['param']['contact']['Work']['myId']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("assistentId", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='assistentId' id='assistentId' value='".$session['response']['param']['contact']['Work']['assistentId']."' maxlength='128' />";
			echo "</div>";
		}
		if (! in_array("managerId", $XCOW_B['sciomino']['personalia-exclude']) ) {
			...
			echo "<input class='text' type='text' name='managerId' id='managerId' value='".$session['response']['param']['contact']['Work']['managerId']."' maxlength='128' />";
			echo "</div>";
		}
		?>
	</fieldset>
	...
	<fieldset>
		...
		<div class="inputset">
			...
			<input class="text" type="text" name="addressWork" id="addressWork" value="<?php echo htmlTokens($session['response']['param']['address']['Work']['address']); ?>" maxlength="128" />
		</div>
		<div class="inputset">
			<label for="postalcodeWork"><?php echo language('sciomio_text_user_profile_address_work_postalcode'); ?></label>
			<input class="text" type="text" name="postalcodeWork" id="postalcodeWork" value="<?php echo htmlTokens($session['response']['param']['address']['Work']['postalcode']); ?>" maxlength="128" />
		</div>
		<div class="inputset">
			<label for="cityWork"><?php echo language('sciomio_text_user_profile_address_work_city'); ?></label>
			<input class="text autocomplete" data-results="<?php echo $XCOW_B['url'] ?>/snippet/suggest-local?type=workplace" type="text" name="cityWork" id="cityWork" value="<?php echo htmlTokens($session['response']['param']['address']['Work']['city']); ?>" maxlength="128" />
		</div>
		<div class="inputset">
			<label for="countryWork"><?php echo language('sciomio_text_user_profile_address_work_country'); ?></label>
			<select name="countryWork" id="countryWork">
