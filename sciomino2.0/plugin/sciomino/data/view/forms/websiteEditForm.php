<form action="<?php echo $XCOW_B['url'] ?>/snippet/website-edit-form" method="post">
    <input class='form_input' type='hidden' name='com_title' value="<?php echo htmlTokens($session['response']['param']['website']['title']); ?>">
    <input class='form_input' type='hidden' name='websiteId' value="<?php echo $session['response']['param']['websiteId']; ?>">
    <label class="icon icon-website" for="website-<?php echo $session['response']['param']['websiteId']; ?>"><?php echo language('sciomio_text_website_'.$session['response']['param']['website']['title']); ?></label>
    <input value="<?php echo htmlTokens($session['response']['param']['website']['relation-self']); ?>" type="text" class="text" name="com_relation-self" id="website-<?php echo $session['response']['param']['websiteId']; ?>" maxlength="256" />
    <div class="interact">
