<form action="<?php echo $XCOW_B['url'] ?>/snippet/tag-edit-form" method="post">
    ...
    <input value="<?php echo htmlTokens($session['response']['param']['tag']['Name']); ?>" type="text" class="text autocomplete" data-results="<?php echo $XCOW_B['url'] ?>/snippet/suggest-local?type=tag" name="com_name" id="<?php echo $session['response']['param']['tagId']; ?>" maxlength="32" />
    <div class="interact">
