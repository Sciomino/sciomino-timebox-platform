...
<body>
	...
	<div id="Content">
		...
		<div class="page">
			<div class="unit unit2-3">
				...
				<div class="section">
				    <div class="hgroup">
					<h2><?php echo language('sciomio_header_user_networks'); ?></h2>
					<h3><?php echo language('sciomio_text_user_networks'); ?></h3>
					</div>
					<div>
					<br/>
					<p><?php echo language('sciomio_text_user_networks_for_users'); ?></p>
					<br/>
				    </div>
				    ...
				    <div class="hgroup">
					<br/>
					<p><?php echo language('sciomio_text_user_networks_for_networks'); ?></p>
				    </div>
	...
	<script type="text/javascript">
		...
		addLoadEvent(function() {ScioMino.User.loadNetworks();});
	</script>
