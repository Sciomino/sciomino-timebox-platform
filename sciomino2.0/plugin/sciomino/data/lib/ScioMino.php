...
// availability is matched on user/profile
// availability profile group is: 'availability'

function ScioMinoApiSaveAvailability ($availability, $userId, $access) {

	$profile = array();
	$profile['group'] = 'availability';

	return UserApiSaveUserProfileAnnotationList($profile, $availability, $userId, $access);

}

function ScioMinoApiUpdateAvailability ($availability, $userId, $availabilityId) {

	return UserApiUpdateUserProfileAnnotation($availability, $userId, $availabilityId);

}

function ScioMinoApiGetAvailability ($userId, $availabilityId) {

	return UserApiGetUserProfile($userId, $availabilityId);

}

function ScioMinoApiListAvailability ($userId) {

	return UserApiListUserProfileByUser("availability", $userId);

}

function ScioMinoApiDeleteAvailability ($userId, $availabilityId) {

	return UserApiDeleteUserProfile($userId, $availabilityId);
