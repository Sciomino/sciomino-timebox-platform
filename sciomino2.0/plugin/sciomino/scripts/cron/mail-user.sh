...
MAILURL="http://sciomino2.0/import/mail-user"

# store the info of the mail send
MAILOUTFILE="/var/www-virtual/sciomino/sciomino2.0/plugin/sciomino/scripts/cron/mail-user.html"
MAILLOGFILE="/var/www-virtual/sciomino/sciomino2.0/plugin/sciomino/scripts/cron/mail-user.log"
