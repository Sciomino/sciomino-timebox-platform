...
<body>
	...
	<div id="Content">
		...
		<div class="page">
			<div class="unit unit2-3">
				...
				<div class="section">
				    <div class="hgroup">
					<h2><?php echo language('sciomio_header_setting_password'); ?></h2>
					<h3><?php echo language('sciomio_text_setting_password'); ?></h3>
					<br/>
				    </div>
	...
	<script type="text/javascript">
		...
		addLoadEvent(function() {Session.Password.updateLoad();});
	</script>
