...
<body>
	...
	<div id="Content">
		...
		<div class="page">
			<div class="unit unit2-3">
				...
				<div class="section">
				    <div class="hgroup">
					<h2><?php echo language('sciomio_header_setting_notification'); ?></h2>
					<h3><?php echo language('sciomio_text_setting_notification'); ?></h3>
					<br/>
				    </div>
	...
	<script type="text/javascript">
		...
		addLoadEvent(function() {ScioMino.Setting.loadNotification();});
	</script>
