<form action="<?php echo $XCOW_B['url'] ?>/snippet/hobby-edit-form" method="post">
    ...
    <input value="<?php echo htmlTokens($session['response']['param']['hobby']['field']); ?>" type="text" class="text autocomplete" data-results="<?php echo $XCOW_B['url'] ?>/snippet/suggest-local?type=hobby" name="com_field" id="<?php echo $session['response']['param']['hobbyId']; ?>" maxlength="32" />
    <div class="interact">
