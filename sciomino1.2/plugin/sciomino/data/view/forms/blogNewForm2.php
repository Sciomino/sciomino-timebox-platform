<form action="<?php echo $XCOW_B['url'] ?>/snippet/blog-edit-form" method="post">
    ...
    <label class="icon icon-<?php echo $session['response']['param']['blogTitle']; ?>" for="<?php echo $session['response']['param']['blogId']; ?>"><?php echo language('sciomio_text_blog_'.$session['response']['param']['blogTitle']); ?></label>
