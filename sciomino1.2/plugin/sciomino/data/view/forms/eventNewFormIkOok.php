	...
	<form action="<?php echo $XCOW_B['url'] ?>/snippet/event-new-form" method="post">
       ...
       <fieldset class="details">
            ...
            <div class="inputset specs">
                ...
                <input id="publisher" type="text" class="text autocomplete" data-results="<?php echo $XCOW_B['url'] ?>/snippet/suggest-local?type=event&subtype=publisher" value="<?php echo htmlTokens($session['response']['param']['fillPublisher']); ?>" name="publisher" maxlength="128" />
