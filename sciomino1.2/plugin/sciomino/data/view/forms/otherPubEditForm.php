<form action="<?php echo $XCOW_B['url'] ?>/snippet/otherPub-edit-form" method="post">
    ...
    <div class="inputset">
        ...
        <input value="<?php echo htmlTokens($session['response']['param']['otherPub']['title']); ?>" type="text" class="text" name="com_title" id="titel-publicatie" maxlength="128" />
        <div class="interact">
    ...
    <div class="inputset ">
        ...
        <input value="<?php echo htmlTokens($session['response']['param']['otherPub']['alternative']); ?>" type="text" class="text" name="alternative" id="subtitel-publicatie" maxlength="128" />
    </div>
    <div class="inputset">
        <label for="description-publicatie"><?php echo language('sciomio_text_publication_description'); ?></label>
        <input type="text" class="text" id="description-publicatie" value="<?php echo htmlTokens($session['response']['param']['otherPub']['description']); ?>" name="description" maxlength="256" />
    </div>
    <div class="inputset ">
        <label for="link-publicatie"><?php echo language('sciomio_text_publication_link'); ?></label>
        <input value="<?php echo htmlTokens($session['response']['param']['otherPub']['relation-self']); ?>" type="text" class="text" name="relation-self" id="link-publicatie" maxlength="256" />
        <div class="interact">
