<form action="<?php echo $XCOW_B['url'] ?>/snippet/share-edit-form" method="post">
    <input class='form_input' type='hidden' name='com_title' value="<?php echo htmlTokens($session['response']['param']['share']['title']); ?>">
    <input class='form_input' type='hidden' name='shareId' value="<?php echo $session['response']['param']['shareId']; ?>">
    <label class="icon icon-slideshare" for="slideshare-<?php echo $session['response']['param']['shareId']; ?>"><?php echo language('sciomio_text_share_'.$session['response']['param']['share']['title']); ?></label>
    <input value="<?php echo htmlTokens($session['response']['param']['share']['relation-self']); ?>" type="text" class="text" name="com_relation-self" id="slideshare-<?php echo $session['response']['param']['shareId']; ?>" maxlength="256" />
    <div class="interact">
