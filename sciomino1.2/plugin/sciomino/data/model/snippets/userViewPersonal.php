...
class userViewPersonal extends control {
	...
	$birthDayList = UserApiListUserWithQuery("format=short&annotation[dateofbirthday]=".$day['day']."&annotation[dateofbirthmonth]=".$day['month']."&annotation_operator=ge&order=birthday&limit=".$faces_limit);
	...
	if (count($firstBirthDayList) < $faces_limit ) {
		...
		$nextBirthDayList = UserApiListUserWithQuery("format=short&annotation[dateofbirthday]=1&annotation[dateofbirthmonth]=".$nextMonth."&annotation_operator=ge&order=birthday&limit=".$faces_limit);
	...
	$newList = UserApiListUserWithQuery("mode=active&format=short&order=date&direction=desc&limit=".$faces_limit);
