...
IDURL="http://sciomino1.2/import/getIds"
MAILURL="http://sciomino1.2/import/availability-update"

# store the info of the mail send
MAILOUTFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/availability-update.html"
MAILLOGFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/availability-update.log"
