...
MAILURL="http://sciomino1.2/import/mail-knowledge"

# store the info of the mail send
MAILOUTFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/mail-knowledge.html"
MAILLOGFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/mail-knowledge.log"
