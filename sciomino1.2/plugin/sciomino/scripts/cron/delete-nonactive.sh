...
MAILURL="http://sciomino1.2/import/delete"

# store the info of the mail send
MAILOUTFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/delete-nonactive.html"
MAILLOGFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/delete-nonactive.log"
