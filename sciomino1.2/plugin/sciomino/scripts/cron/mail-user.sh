...
MAILURL="http://sciomino1.2/import/mail-user"

# store the info of the mail send
MAILOUTFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/mail-user.html"
MAILLOGFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/mail-user.log"
