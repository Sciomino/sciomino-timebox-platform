...
IDURL="http://sciomino1.2/import/getActIds"
MAILURL="http://sciomino1.2/import/mail-react"

# store the info of the mail send
MAILOUTFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/mail-react.html"
MAILLOGFILE="/var/www-virtual/sciomino/sciomino1.2/plugin/sciomino/scripts/cron/mail-react.log"
