...
cp xcow.css ../../../htdocs/css/xcow.css 
cp config.js ../../../htdocs/js/config.js 
cp XMLexchange.js ../../../htdocs/js/XMLexchange.js 
#copy session files
...
cp session_view/login2.php ../../../data/view/base/session/login2.php
